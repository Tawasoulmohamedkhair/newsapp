...
// ✅ عملناه دالة بترجع GoRouter عشان نقدر نسجله في get_it بسهولة
// ومش بيتم تنفيذه غير لما نادي الدالة دي في service_locator
GoRouter createRouter() {
  return GoRouter(
    initialLocation: '/splash',

    // ✅ لأن AppFlowController شغال بـ ChangeNotifier، نقدر نمرره مباشرة
    // عشان GoRouter يسمع للتغييرات ويعمل redirect تلقائي
    refreshListenable: getIt<AppFlowController>(),
